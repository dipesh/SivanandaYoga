export default quotes = ["Come! Learn the lessons in Yoga-practice.  Meditate.  Tear the veil.  Go.  Dwell in peace.",
  ...
  "Behold the Divinity in all beings. Great everyone as the Lord himself. Feel the presence of the Lord everywhere.",
  ...
  "Every child has within him a life force. Give him opportunities to express himself. Do not repress the life force. Education is introduction to Life. It must be nonsectarian. It must aim at friendship and fellowship with different communities.",
  ...
  "Remember and practise the \"Three D\’s\" — Discrimination (Viveka), Dispassion (Vairagya) and Determination.",
  ...
  "Lead a inner spiritual life. Fight against the dark evil forces.",
  ...
  "Practise Ahimsa (Non Violence), Satyam (Truth), and Brahmacharya (Celibacy). At the same time practice meditation, also.",
  ...
  "There has been exceptional instances when illumination has come suddenly and has instantly transformed Life.",
  ...
  "Do vigourous Yoga Sadhana. Be sincere. Be patient. Victory shall always be yours.",
  "Plod on. Strive, strive. Meditate, meditate. March on, brave lion, O Adhyatmic (spiritual) hero.",
  "Persevere. Plod on in you Sadhana. Give up idle talk, tall talk, gossiping and back biting. Save your time.",
  ...
  "A thirsting aspirant should practise self-denial.",
  ...
  "An aethiest denies God.  The denier exists.  Existence is God or Brahman.",
  ...
  "There is no short-cut to God-realization.",
  ...
  "O wanderer in the desert of this universe! O Pilgrim! O traveller! Beware of all mirages, of all temptations.  March direct to your goal - the mighty Oasis of Brahman.",
  ...
  "The Upanishads from the concluding portion of the Veda and are therefore called the Vedanta, or the end of the Vedas.",
  ...
  "Vedanta is no creed, no ceremony, or form of worshship.  It is the supreme science of the Reality.",
  "Vedanta boldy proclaims with emphasis that you are the immortal, all-pervading Atman in essence.",
  ...
  "This Atman is the great Unity.  It is the hightest freedom.",
  ...
  "Perfection, freedom, independence are attained only by direct experience or wisdom of Atman.",
  ...
  "He Knows, who realizes the <b><i>Self</i></b>(Big Self) within the self(small self).",
  ...
  "\’I\’, \’You\’, \’He\’, \’This\’, \’That\’ and the hosts of phantoms that Avidya creates, nave always been illusory and delusive.",
  ...
  "Empty yourself of you egoism; then the Divine will fill your heart to the brim.",
  ...
  "Practise self-denial.  Cultivate indifference or dispassion.  Practise meditation regularly.  This will enable you to enter the Kingdom of everlasting peace and bliss.",
  ...
  "There is Truth where righteousness is.  Realize the Truth by practising righteousness.",
  ...
  "Purity is the first requisite for God-realization.  There cultivate purity.",
  ...
  "A pure heart is necessary to now the Will of God.",
  ...
  "You cannot practise Ahimsa(Non-Violence) without practising truth.",
  ...
  "Attain Truth through speaking the truth and practising truth in all your daily actions and behaviour towards others.",
  ...
  "Character is the term which designates the distinctive qualities a person manifests in his relation with his fellows.",
  ...
  "Your character depends upon the quality of thought held in your mind and the mental pictures and ideals entertained by your.  Avoid useless and base thinking.",
  ...
  "Both scorch you heart.  Extinguish these fires through love and purity.",
  ...
  "Ever live within your income.  Save when your are young.  Spend when you are old.  Never run into debt.",
  ...
  "Meditate in Brahmamuhurta.  Practise meditation regularly.  Meditation leads to eternal bliss.  Therefore meditate, meditate.",
  ...
  "Blend you love for your wife, son and property into one and direct it to God.  You will attain God-realization this very second.",
  ...
  "The essential condition of spirituality is th annihilation of desire for mundane objects.  You should have Vairagya or dispassion.",
  ...
  "Moral values, and a culture and a religion, maintaining these values is far better than laws and regulations.",
  ...
  "Bear no envy.  Commit no slander.  Speak no falsehood.  Practise no deceit.  Harbour no malice.  You will be ever joyful, happy and peaceful.",
